      ...
      <div className="messenger">
        <div className="chatMenu">
          <div className="chatMenuWrapper" >
             <p style={{fontSize:"20px",marginLeft:"40px",fontFamily:"monsterrat,sans-serif"}}>Users</p>
            {conversations.map((e) => (
              <div className="dec" onClick={() => setCurrentChat(e)}>
            ...
            {currentChat ? (
              <>
                <div className="chatBoxTop">
                  {messages.map((e) => (
                    <div ref={scrollRef}>
                      <Message message={e} own={e.sender === user._id} />
                    </div>
                  ))}
                </div>
                <div className="chatBoxBottom">
                  <textarea
                    ...
                    value={newMessage}
                  ></textarea>
                  <button style={{color:"white",marginRight:"70px"}}className="chatSubmitButton" onClick={handleSubmit}>
                    Send
                  </button>
                </div>
              </>
